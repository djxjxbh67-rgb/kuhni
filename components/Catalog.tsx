...
const Catalog: React.FC = () => {
  return (
    <section id="каталог" className="py-12 sm:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-10 sm:mb-16 space-y-3 sm:space-y-4">
          <h2 className="text-2xl sm:text-4xl font-black text-slate-900 uppercase">Популярные модели 2024</h2>
          <div className="w-16 sm:w-24 h-2 bg-yellow-400 mx-auto rounded-full"></div>
