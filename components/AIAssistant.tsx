  ...
  return (
    <div className="fixed bottom-20 sm:bottom-6 right-4 sm:right-6 z-[100]">
      ...
      <button
        ...
        className="w-12 h-12 sm:w-14 sm:h-14 bg-indigo-600 text-white rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-transform animate-pulse"
      >
        <i className={`fa-solid ${isOpen ? 'fa-xmark' : 'fa-robot'} text-lg sm:text-xl`}></i>
      </button>

      {/* Chat Window */}
      {isOpen && (
        <div className="absolute bottom-16 -right-2 sm:right-0 w-[300px] sm:w-[350px] md:w-[400px] bg-white rounded-3xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden animate-fade-in-up">
