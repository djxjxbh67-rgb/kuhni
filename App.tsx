        ...
        <section className="py-12 sm:py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center mb-8 sm:mb-16">
              <h2 className="text-2xl sm:text-4xl font-black text-slate-900 mb-2 sm:mb-4 uppercase">Отзывы наших заказчиков</h2>
              <p className="text-sm sm:text-base text-slate-500">Уже более 3000 выполненных проектов по всей области</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              {[1, 2, 3].map(i => (
                <div key={i} className="p-6 sm:p-8 bg-slate-50 rounded-2xl sm:rounded-3xl border border-slate-100 space-y-3 sm:space-y-4">
